...
let sumBoardTwo = 0;
let sumBoardThree = 0;
let patternCorrector = undefined;
let patterCorrectorDown = undefined;
let checkBoard = [];
let test = undefined;
  ...
  for (let ii = 0; ii<completeBoard.length; ii++) {
    for (let jj = 0; jj<completeBoard[ii].length; jj++) {
      for (let kk = 0; kk<completeBoard[ii][jj].length; kk++) {
        ...
        if (jj === 0) {
          if (puzzleBoardDown[kk][ll][ii][jj+1] > 0 && puzzleBoardDown[kk][ll][ii][jj+2] > 0){
            patternCorrectorDown = false;
          }
          else {
            patternCorrectorDown = true;
          }
        }
        else if (jj === 1) {
          if (puzzleBoardDown[kk][ll][ii][jj+1] > 0 && puzzleBoardDown[kk][ll][ii][jj-1] > 0){
            patternCorrectorDown = false;
          }
          else {
            patternCorrectorDown = true;
          ...
          if (puzzleBoardDown[kk][ll][ii][kk-1] > 0 && puzzleBoardDown[kk][ll][ii][jj-2] > 0){
            patternCorrectorDown = false;
          }
          else {
            patternCorrectorDown = true;
          ...
          if (numberOne < 0.5 && patternCorrector === true && patternCorrectorDown === true) {
...
$('#pause').click(function() {
  alert('Paused - click close to continue. ');
});
